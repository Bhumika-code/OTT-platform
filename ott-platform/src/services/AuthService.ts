...
// export const signIn = async (user: SignInData): Promise<boolean> => {
//   try {
//     const response = await axios.post('https://maiora-backend-dev.onrender.com/auth/signin', user, {
//       headers: {
//         'Content-Type': 'application/json',
//       },
//     });
...
// export const registerUser = async (user: RegistrationData): Promise<boolean> => {
//   try {
//     const response = await axios.post('https://maiora-backend-dev.onrender.com/auth/register', user, {
//       headers: {
//         'Content-Type': 'application/json',
//       },
//     });
